...
BEGIN_MESSAGE_MAP(CMCadView1, CView)
	...
	ON_WM_MOUSEACTIVATE()
	ON_WM_SHOWWINDOW()
    ON_MESSAGE(WM_MYMESSAGE_PARTSEDIT, OnMyMessagePtsEdit)			// 1
    ON_MESSAGE(WM_MYMESSAGE_GRIDNUM, OnMyMessageGridNum)				// 1
    ON_MESSAGE(WM_MYMESSAGE_STATUSBAR, OnMyMessageStatusBar)			// 1
    ON_MESSAGE(WM_MYMESSAGE_OPTION, OnMyMessageOpt)					// 1
    ON_MESSAGE(WM_MYMESSAGE_HIST, OnMyMessageHist)					// 1
	ON_MESSAGE(WM_MYMESSAGE_TENKAI, OnMyMessageTenkai)				// 1
	ON_MESSAGE(WM_MYMESSAGE_KATTR, OnMyMessageKAttr)					// 1
