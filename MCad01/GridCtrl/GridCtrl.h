...
#ifdef DLL_EXPORT_GRIDCTRL_DO
	#define DLL_EXPORT							__declspec( dllexport)
#else
	//#ifdef DLL_NO_IMPORT_GRIDCTRL_DO
		#define DLL_EXPORT
	//#else
...
class DLL_EXPORT CGridCtrl : public CWnd
{
...
public:
    ...
    int      GetDefCellWidth() const         { return m_cellDefault.GetMbWidth();     }
    ...
    CCellID GetFocusCell() const                  { return m_idCurCell;           }
...
protected:
    ...
    CCellID     m_idCurCell, m_idTopLeftCell;
    int         m_nTimerID;
