...
//					   | m31 m32 m33 |
//
inline	MgSLine2D operator * ( const MgSLine2D& i_sln, const MgMat2D& i_mt)	// *	座標変換
{
...
//			             				  | m31 m32 m33 |
//
inline	MgSLine2D operator *= ( MgSLine2D& io_sln, const MgMat2D& i_mt)		// *=	座標変換
{
...
////			   			  | m31 m32 0 m33 |
////
//inline MgSLine3D operator * ( const MgSLine3D& i_SLn, const MgMat2D& i_mt)	// *	座標変換
//{
...
////				 				   				| m31 m32 0 m33 |
////
//inline MgSLine3D operator *= ( MgSLine3D& io_SLn, const MgMat2D& i_mt)		// *=	座標変換
//{
...
//							| m41 m42 m43 m44 |
//
inline MgSLine3D operator * ( const MgSLine3D& i_SLn1, const MgMat3D& i_Mt2)		// 座標変換
{
...
//													| m41 m42 m43 m44 |
//
inline MgSLine3D operator *= ( MgSLine3D& io_SLn1, const MgMat3D& i_Mt2)			// 座標変換
{
