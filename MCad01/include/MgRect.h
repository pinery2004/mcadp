...
public:
	...
	MgMinMaxI2 operator + ( const CPoint &pt) const									// mm1 = mm2 + pt
						{ return MgMinMaxI2( min + pt, max + pt);}
	MgMinMaxI2 operator - ( const CPoint &pt) const									// mm1 = mm2 - pt
						{ return MgMinMaxI2( min - pt, max - pt);}
...
public:
	...
	MgMinMaxR2 operator + ( const MgVect2& pt) const								// mm1 = mm2 + pt
						{ return MgMinMaxR2( min + pt, max + pt);}
	MgMinMaxR2 operator - ( const MgVect2& pt) const								// mm1 = mm2 - pt
						{ return MgMinMaxR2( min - pt, max - pt);}
	MgMinMaxR2 operator += ( const MgVect2& pt)										// mm1 += pt
						{ min += pt; max += pt; return *this;}
	MgMinMaxR2 operator -= ( const MgVect2& pt)										// mm1 -= pt
						{ min -= pt; max -= pt; return *this;}
...
public:
	...
	MgMinMaxR3 operator + ( const MgVect3& pt) const								// mm1 = mm2 + pt
...
public:
	...
	MgRect2 operator + ( const MgVect2& pt) const									// rc1 = rc2 + pt
						{ return MgRect2( p[0] + pt,
										 p[1] + pt);}
	MgRect2 operator - ( const MgVect2& pt) const									// rc1 = rc2 - pt
						{ return MgRect2( p[0] - pt,
										 p[1] - pt);}
	MgRect2 operator += ( const MgVect2& pt)										// rc1 += pt
...
public:
	...
	MgRect3 operator + ( const MgVect3& pt) const								// rc1 = rc2 + pt
						{ return MgRect3( p[0] + pt,
										  p[1] + pt);}
	MgRect3 operator - ( const MgVect3& pt) const								// rc1 = rc2 - pt
						{ return MgRect3( p[0] - pt,
										  p[1] - pt);}
	MgRect3 operator += ( const MgVect3& pt)									// rc1 += pt
						{ p[0] += pt; p[1] += pt; return *this;}
