...
//
//inline MgCir2D MgCir2DC( const MgPoint3D& Pc, const MREAL r1)					// ‚RŸŒ³(x,y)¨‚QŸŒ³
...
inline MgCir3D MgCir3DC( const MgPoint2D& pc, const MREAL r, const MgPlane3D& Pln)	// ‚QŸŒ³¨‚RŸŒ³	(•½–Êã)
