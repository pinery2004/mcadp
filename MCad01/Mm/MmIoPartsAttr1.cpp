...
void mmIoPartsAttr::InitComboMbr()
{
	MhMbr	*pMbr;
	int		ic1;
	int		ic;
...
void mmIoPartsAttr::SelectComboMbrByKmId(
...
int mmIoPartsAttr::SelectComboMbrByMbrCd( MCHAR* sCdMbr)
{
	int			iMbrId = -1;
	int			iKmIdMbr;
	...
	z_mmIA.SelectComboMbrByKmId( iKmIdMbr);
