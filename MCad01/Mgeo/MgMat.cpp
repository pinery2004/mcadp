...
// ---------------------( ３次元 )------------------------------
//
MgMat4 MGeo::Mat4Mirror(							// (  O) 鏡像変換行列
...
// ---------------------( ３次元 )------------------------------
//
MgMat4 MGeo::Mat4NProj(								// (  O) 正投象変換行列
...
// ---------------------( ３次元 )------------------------------
//
MgMat4 MGeo::Mat4SProj(								// (  O) 斜投象変座標変換行列
				const	MgMat4		&i_Tm,			// (I  ) 入力座標変換行列
				const	MgPlane3	&i_Pln,			// (I  ) 投象面
...
// ---------------------( ３次元 )------------------------------
//
MgMat4 MGeo::Mat3Dto2D(									// (  O) 座標変換行列
