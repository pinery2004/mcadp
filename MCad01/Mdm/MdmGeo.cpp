...
//S long MdmGeo::VecLen ( long nd, double vec[], double *len ) { return 0;};
...
//S long MdmGeo::Point3DPressSamePoint ( double lp[], long *n ) { return 0;};
...
//S void MdmGeo::Tbl2DMult ( double tbl1[6], double tbl2[6], double tbl[6] ) { };
